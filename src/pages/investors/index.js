...
<div id='lifeFinancing' className='bg-white py-20'>
            ...
            >
              <div className='flex flex-col items-center justify-between gap-8 md:flex-row'>
                <div className='w-full'>
                  <p className='mb-2 text-sm uppercase tracking-wide text-white/80'>{t('lifeFinancingSubtitle')}</p>
                  <h2 className='mb-4 text-3xl md:text-4xl text-white'>{t('lifeFinancingTitle')}</h2>
                  <p className='text-lg text-white/90'>{t('lifeFinancingDescription')}</p>
                </div>

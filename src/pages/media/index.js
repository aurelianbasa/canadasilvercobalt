            ...
            <TabPanel className='flex flex-col gap-16'>
              ...
              <div className='grid gap-10'>
                ...
                >
                  <motion.div variants={items}>
                    <CardVideo
                      date={t('video_2026_08_05_Date')}
                      subtitle={t('video_2026_08_05_Subtitle')}
                      title={t('video_2026_08_05_Title')}
                      src='https://www.youtube.com/embed/p95gcxL2GXs'
                    ></CardVideo>
                  </motion.div>
                  <motion.div variants={items}>
                    <CardVideo
                  ...
                  <motion.div variants={items}>
                    <CardVideo
                      ...
                      src='https://www.youtube.com/embed/k3MGifS0XRw?si=V8AxTaK4z9dTa8m6'
                    ></CardVideo>
                  </motion.div>
                  <motion.div variants={items}>
                    <CardVideo
                      date={t('video_2026_06_03_Date')}
                      subtitle={t('video_2026_06_03_Subtitle')}
                      title={t('video_2026_06_03_Title')}
                      src='https://www.youtube.com/embed/-tu9P_Sosdc?si=1'
                    ></CardVideo>
                  </motion.div>
                  <motion.div variants={items}>
                    <CardVideo
                      date={t('video_2026_03_15_Date')}
                      subtitle={t('video_2026_03_15_Subtitle')}
                      title={t('video_2026_03_15_Title')}
                      src='https://www.youtube.com/embed/VsW0cPeVbfE?si=1'
                    ></CardVideo>
                  </motion.div>
                  <motion.div variants={items}>
                    <CardVideo
                      date={t('video_2026_02_27_Date')}
                      subtitle={t('video_2026_02_27_Subtitle')}
                      title={t('video_2026_02_27_Title')}
                      src='https://www.youtube.com/embed/eNOKBUZe2TM?si=1'
                    ></CardVideo>
                  </motion.div>
                  <motion.div variants={items}>
                    <CardVideo
                ...
                >
                  ...
                  <motion.div variants={items}>
                    <CardVideo
                      ...
                      subtitle={t('video_2025_08_13_Subtitle')}
                      title={t('video_2025_08_13_Title')}
                      src='https://www.youtube.com/embed/ccZpfe4GXpw?si=gs6uWLo7mB2TU9HC'
                    ></CardVideo>
                  </motion.div>
                  <motion.div variants={items}>
                    <CardVideo
                      date={t('video_2025_07_09_Date')}
                      subtitle={t('video_2025_07_09_Subtitle')}
                      title={t('video_2025_07_09_Title')}
                    ...
                    <CardVideo
                      ...
                      src='https://www.youtube.com/embed/QPWbIW3Uk6A?si=WqY1oJVf_AzN9xCc'
                    ></CardVideo>
                  </motion.div>
                    <motion.div variants={items}>
                    <CardVideo
